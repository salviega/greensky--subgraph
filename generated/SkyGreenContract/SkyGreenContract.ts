...
export class SkyGreenContract__checkUpkeepResult {
  value0: boolean;
  value1: Bytes;
...
export class SkyGreenContract extends ethereum.SmartContract {
  static bind(address: Address): SkyGreenContract {
    return new SkyGreenContract("SkyGreenContract", address);
  }
  ...
  checkUpkeep(param0: Bytes): SkyGreenContract__checkUpkeepResult {
    let result = super.call("checkUpkeep", "checkUpkeep(bytes):(bool,bytes)", [
      ethereum.Value.fromBytes(param0)
    ]);

    return new SkyGreenContract__checkUpkeepResult(
      result[0].toBoolean(),
      result[1].toBytes()
    );
  }
  ...
  try_checkUpkeep(
    param0: Bytes
  ): ethereum.CallResult<SkyGreenContract__checkUpkeepResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SkyGreenContract__checkUpkeepResult(
        value[0].toBoolean(),
        value[1].toBytes()
      )
    );
